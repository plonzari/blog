...
<a href="https://www.statnews.com/2020/11/16/modernas-covid-19-vaccine-is-strongly-effective-early-look-at-data-show"> 
 ...
 $$\int dp_1 dp_2 P(p_1 if N_1,V_1)P(p_2 if N_2,V_2)  \theta(1-\frac{p_1}{p_2}-V_l)=.001$$.
 
 A very simple model would imply $$P(p_i if N_i,V_i)=K_i p_i^V_i (1-p_i)^(N_i-V_i)$$ with $$K_i$$ an appropriate 
