...
<a href="https://www.statnews.com/2020/11/16/modernas-covid-19-vaccine-is-strongly-effective-early-look-at-data-show"> 
 ...
 A very simple model would imply $$P(p_i|N_i,V_i)=K_i p_i^V_i (1-p_i)^(N_i-V_i)$$ with $$K_i$$ an appropriate 
 ...
 propagate if $$V_e<1-\fer{1}{R}$$. Therefore $$V_e$$ has to be better than the proportion of infected population 
