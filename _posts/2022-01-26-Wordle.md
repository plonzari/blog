...
The root of the tree is the empty configuration with 12972 x 2315 children on the first level.
...
2. nodes with more than one compatible solution. Tyey correspond to a  possible loss.
...
$$g_{loss}$$. Then the child of the root with the highest average $g$ provides the perfect guess and $g$ at 
the root is the average number of guesses needed.
