...
The short answer is yes, there is a strategy to always find the answer in six words and less. And my best starting 
point is <a href="https://www.collinsdictionary.com/dictionary/english/laten"> LATEN </a>.
...
FLAKS, SERVE, RIGOL, BLOND, and TESTY  one can always solve WORDLE in 3.9 steps in average.  Check out a 
text solver <a href="https://github.com/plonzari/Wordle"> here. </a> The best strategy probably needs more
words for the guesses but the game tree gets too big. Next step would be to use the same approach for the 
Hard Mode of the game. Because in that mode any "hints must be used in subsequent guesses" the game-tree
